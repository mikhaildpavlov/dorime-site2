...
const translations = {
  en: {
    ...
    "about.title":"We create sound<br>that <em>stays</em><br>with you.","about.lead":"DorimЭ is a professional voiceover studio bringing together voice talent, direction, sound engineering and modern post-production.","about.text":"We turn a script into sound that works for your goal — from a short video to a complete audio production.","about.stat1":"Professional<br>recording","about.stat2":"Experienced<br>voice talent","about.stat3":"Post-<br>production","about.stat4":"Personal<br>approach","about.quality":"studio quality",
    ...
    "portfolio.title":"Listen to<br><em>how it sounds.</em>","portfolio.all":"All","portfolio.dub":"Dubbing","portfolio.voice":"Voiceover","portfolio.ad":"Advertising","portfolio.placeholder":"Add MP4 / MOV","portfolio.demo":"Demo reel","portfolio.note":"The structure is ready for real videos. Replace the placeholders with MP4/MOV files in the assets folder.",
  ...
  ru: {
    ...
    "about.title":"Мы создаём звук,<br>который <em>остаётся</em><br>с вами.","about.lead":"DorimЭ — профессиональная студия озвучивания, где голос, режиссура, звукорежиссура и современный постпродакшен работают как единое целое.","about.text":"Мы превращаем сценарий в звук, который работает на вашу задачу — от короткого ролика до полноценного аудиопродакшена.","about.stat1":"Профессиональная<br>запись","about.stat2":"Опытные<br>дикторы","about.stat3":"Пост-<br>продакшен","about.stat4":"Индивидуальный<br>подход","about.quality":"качество студии",
    ...
    "portfolio.title":"Послушайте,<br><em>как это звучит.</em>","portfolio.all":"Все","portfolio.dub":"Дубляж","portfolio.voice":"Закадр","portfolio.ad":"Реклама","portfolio.placeholder":"Добавьте MP4 / MOV","portfolio.demo":"Демо-ролик","portfolio.note":"Структура готова для реальных видео. Замените placeholders на MP4/MOV в папке assets.",
